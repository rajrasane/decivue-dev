...
export function SiteHeader() {
    ...
    return (
        <header className="sticky top-0 z-40 w-full border-b border-white/10 bg-black/50 backdrop-blur-xl supports-backdrop-filter:bg-black/50">
            <div className="max-w-6xl mx-auto px-4 md:px-6 h-14 sm:h-16 md:h-20 flex items-center justify-between">
                        ...
                        {user ? (
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <button className="relative flex items-center rounded-full outline-none ring-offset-2 ring-offset-black focus-visible:ring-2 focus-visible:ring-white/30 cursor-pointer">
