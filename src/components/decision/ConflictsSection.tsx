    ...
    return (
        <section className="mb-6 bg-red-500/10 border border-red-500/30 rounded-xl p-4 sm:p-6" aria-labelledby="conflicts-heading">
            ...
            <p className="text-xs sm:text-sm text-(--text-muted) mb-3 sm:mb-4">
                These decisions may contradict each other. Review and resolve.
            </p>
            <div className="space-y-3">
                {conflicts.map((conflict) => (
                    <article key={conflict.id} className="p-3 sm:p-4 rounded-lg bg-(--bg-card) border border-red-500/20">
