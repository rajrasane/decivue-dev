            ...
            <div className="w-full max-w-[380px]">
                ...
                <div className="rounded-2xl border border-white/[0.06] bg-[var(--bg-secondary)] p-5 shadow-2xl sm:p-6">
                    ...
                    <div className="flex flex-col gap-2.5">
                        ...
                        >
                            <svg className="h-[18px] w-[18px]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                    <linearGradient id="gBlue" x1="21.6" y1="5.4" x2="5.4" y2="21.6" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#1A73E8" />
                                        <stop offset="1" stopColor="#0D47A1" />
                                    </linearGradient>
                                    <linearGradient id="gGreen" x1="9" y1="20" x2="15" y2="10" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#0D652D" />
                                        <stop offset="1" stopColor="#34A853" />
                                    </linearGradient>
                                    <linearGradient id="gYellow" x1="2" y1="13" x2="10" y2="7" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#E37400" />
                                        <stop offset="1" stopColor="#FBBC04" />
                                    </linearGradient>
                                    <linearGradient id="gRed" x1="16" y1="4" x2="8" y2="12" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#D93025" />
                                        <stop offset="1" stopColor="#EA4335" />
                                    </linearGradient>
                                </defs>
                                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 01-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="url(#gBlue)" />
                                <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="url(#gGreen)" />
                                <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="url(#gYellow)" />
                                <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="url(#gRed)" />
                            </svg>
                    ...
                    <form onSubmit={handleEmailAuth} className="space-y-3.5">
                        ...
                        <div>
                            <label htmlFor="password" className="mb-1 block text-xs font-medium text-[var(--text-secondary)]">Password</label>
